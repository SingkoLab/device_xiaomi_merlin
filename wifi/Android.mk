...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.merlin.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.merlin.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.merlin
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.merlin.rc \
    android.hardware.wifi@1.0-service.merlin.xml
